...
public class PhaseTen extends PhasePrincipal {
    ...
    void begin() {
        ...
        displaySewerBottom = displaySewerTop = changeDirection = true;
    ...
    void play() {
        ...
        if (sewerBottom.isGone() && time.get() > 0) {
            ...
            if (changeDirection) {
                sewerTopHeight = sewerTopHeight + spaceBetweenSewers / 2 + 250;
                sewerBottomHeight = sewerBottomHeight - spaceBetweenSewers / 2 + 250;
                displaySewerTop = true;
                displaySewerBottom = Math.random() < 0.5;
            } else {
                sewerTopHeight = sewerTopHeight + spaceBetweenSewers / 2 - 250;
                sewerBottomHeight = sewerBottomHeight - spaceBetweenSewers / 2 - 250;
                displaySewerBottom = true;
                displaySewerTop = Math.random() < 0.5;
            }
